...
const serviceBusInfoImport = require("./serviceBusInfo");
const serviceBusInfo = new serviceBusInfoImport.ServiceBusInfo();
...
async function main() {
    const credential = new identity.ClientSecretCredential(serviceBusInfo.TenantId, serviceBusInfo.ClientId, serviceBusInfo.ClientSecret);
    const sbClient = new serviceBus.ServiceBusClient(serviceBusInfo.Namespace, credential);
    ...
    try {
        const subscription = receiver.subscribe({
            ...
            processError: async (args) => {
                ...
                if ((0, serviceBus.isServiceBusError)(args.error)) {
                    switch (args.error.code) {
                        ...
                        case "ServiceBusy":
                            ...
                            await (0, serviceBus.delay)(10000);
                            break;
                    }
                }
            }
        ...
        await (0, serviceBus.delay)(20000);
        console.log(`Closing...`);
